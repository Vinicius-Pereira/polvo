    ...
    <div class="col-md-10 col-md-offset-1">
      ...
      <div class="col-md-12">
        ...
        <div class="form-group col-md-3">
          ...
          <input id="data" type="date" name="dataPedido" class="form-control" value="<?php echo $pedido->getData(); ?>" disabled="true"/>
        </div>
        <div class="form-group col-md-3 col-md-offset-3">
          <label for="total">Total:</label>
          <input id="total" type="text" name="total" class="form-control" value="<?php echo "R$" . number_format($pedido->getTotal(), 2); ?>" disabled="true"/>
        </div>
        <div class="form-group col-md-3 gasparzinho">
          <label for="data">olá</label>
          <input id="id" type="text" name="id" class="form-control" value="<?php echo $pedido->getId(); ?>" disabled="true"/>
        </div>
